		...
		try {
			...
			while (!salir) {
				...
				case ADMIN:
					...
					case 2:
						System.out.println("Gestionar credenciales");
						boolean salirCredenciales = false;
						while (!salirCredenciales) {
							System.out.println("== Gestión de credenciales ==");
							System.out.println("1. Crear persona/usuario");
							System.out.println("2. Modificar persona/usuario");
							System.out.println("3. Eliminar persona/usuario");
							System.out.println("4. Listar personas/usuarios");
							System.out.println("0. Volver");

							System.out.print("Elige opción: ");
							int opcionCred = teclado.nextInt();
							teclado.nextLine();
							...
							case 1:
								...
								persona.setPerfil(Perfil.valueOf(perfil.toUpperCase()));

								credencial = new Credencial();
								credencial.setNombre(usuario);
								credencial.setPassword(clave);

								personaServicio.registrarPersona(persona, credencial, idPais);
							...
							case 2:
								...
								personaMod.setId(idPersona);
								personaMod.setNombre(nuevoNombre);

								personaServicio.actualizarPersona(personaMod, sesion);
								System.out.println("Persona modificada correctamente.");
								break;

							case 3:
								System.out.print("ID de la persona a eliminar: ");
								Long idDelPersona = teclado.nextLong();
								teclado.nextLine();

								personaServicio.eliminarPersona(idDelPersona);
					...
					case 3:
						System.out.println("Gestionar espectaculos");

						break;

					case 4: // Ver todos los datos del circo
