...
public class PersonaServicio {
	...
	public boolean login(String usuario, String password) {
		try {
			...
			// Login admin
			if (usuarioAdmin != null && passwordAdmin != null && usuarioAdmin.equals(usuario)
			...
			if (persona != null) {
				...
				System.out.println(
						"Login correcto. Bienvenido/a " + persona.getNombre() + " con perfil " + persona.getPerfil());
				return true;
			} else {
	...
	// Actualizar persona
	public void actualizarPersona(Persona persona, Sesion sesion) {
		try {
			if (sesion.getPerfilActual() == Perfil.ADMIN) {
				personaDAO.actualizar(persona);
			} else {
				System.out.println("No tienes permisos para actualizar");
			}
